...
class KDTree
{
  ...
  private:
    ...
    KDTreeNode* KDTreeHelper(vector<Point<Dim>>& Points, int dim, unsigned left, unsigned right);
    Point<Dim>& select(vector<Point<Dim>>& list, int dim, unsigned left, unsigned right, unsigned k);
